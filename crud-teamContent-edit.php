...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES["image_content"])) {
        ...
        $jobImageQuery = "SELECT `image_content` FROM `team_content` WHERE id = $id";
        ...
        $sql = "UPDATE `team_content` SET `image_content` = '$image_content', `name_content` = '$name_content', `position_content` = '$position_content' WHERE `id` = $id";
        ...
        $sql = "UPDATE `team_content` SET `name_content` = '$name_content', `position_content` = '$position_content' WHERE `id` = $id";
