...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES["image_content"])) {
        ...
        $jobImageQuery = "SELECT `image_content` FROM `service_content` WHERE id = $id";
        ...
        $sql = "UPDATE `service_content` SET `image_content` = '$image_content', `title_content` = '$title_content', `description_content` = '$description_content' WHERE `id` = $id";
        ...
        $sql = "UPDATE `service_content` SET `title_content` = '$title_content', `description_content` = '$description_content' WHERE `id` = $id";
