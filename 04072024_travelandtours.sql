...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2024 at 04:25 PM
...
CREATE TABLE `travelpackage` (
  `id` int(11) NOT NULL,
  `travel_package_image` varchar(255) DEFAULT NULL,
  `travel_package_price` varchar(255) DEFAULT NULL,
  `travel_package_promo` varchar(255) DEFAULT NULL,
  `travel_package_location` varchar(255) DEFAULT NULL,
  `travel_package_contact` varchar(255) DEFAULT NULL,
  `travel_package_description_title` varchar(255) DEFAULT NULL,
  `travel_package_description_content` text DEFAULT NULL,
  `travel_package_contact_details` varchar(255) DEFAULT NULL,
  `date_created` date DEFAULT curdate()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `travelpackage` (`id`, `travel_package_image`, `travel_package_price`, `travel_package_promo`, `travel_package_location`, `travel_package_contact`, `travel_package_description_title`, `travel_package_description_content`, `travel_package_contact_details`, `date_created`) VALUES
(2, '1712480859_aa.jpg', 'test1', 'test1', 'test1', 'test1', 'test1', 'test1', 'test1', '2024-04-07'),
(3, '1712481182_jujutsu-kaisen-megumi-toji-fushiguro-uhdpaper.com-4K-8.2561.jpg', 'test', 'test', 'test', 'test', 'test', 'test', 'test', '2024-04-07'),
(4, '1712481374_jujutsu-kaisen-megumi-toji-fushiguro-uhdpaper.com-4K-8.2561.jpg', 'titi', 'titi', 'titi', 'titi', 'titi', 'titi', 'titi', '2024-04-07'),
(5, '1712499756_qqq.jpg', 'test_edit', 'test_edit', 'test_edit', 'test_edit', 'test_edit', 'test_edit', 'test_edit', '2024-04-07');
