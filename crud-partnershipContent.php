...
<body>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" id="addUserAdminModalContent">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Add Partnership Content</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body add_jobPost">
                            <div class="form-group">
                                <label>Partnership Image</label>
            ...
            <div id="viewUserAdminModal" class="modal fade">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" id="viewUserAdminModalContent">
                        <div class="modal-header">
                            <h4 class="modal-title">Partnership Content Details</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
            ...
            <div id="editUserAdminModal" class="modal fade">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" id="editUserAdminModalContent">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Partnership Content</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body edit_jobPost">
                            <div class="form-group">
                                <label>Current Partnership Image</label>
            ...
            <div id="deleteUserAdminModal" class="modal fade">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content" id="deleteUserAdminModalContent">
                        <div class="modal-header">
                            <h4 class="modal-title">Delete Partnership Content</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
    ...
    <script>
        ...
        function addJobPost() {
            ...
            if (!image_content || !title_content) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: "crud-partnershipContent-add.php",
                success: function (data) {
                    let response = JSON.parse(data);
        ...
        function viewJobPost(id = 2) {
            $.ajax({
                ...
                url: "crud-partnershipContent-view.php",
                success: function (data) {
                    let response = JSON.parse(data);
        ...
        function editJobPost() {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: "crud-partnershipContent-edit.php",
                success: function (data) {
                    let response = JSON.parse(data);
        ...
        function deleteJobPost() {
            ...
            $.ajax({
                ...
                url: "crud-partnershipContent-delete.php",
                success: function (data) {
