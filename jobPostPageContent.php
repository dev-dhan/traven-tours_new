...
<head>
    ...
    - favicon
    -->
    <link rel="shortcut icon" href="./assets/images/talentusph_logo.png">
...
<body>
    ...
    <script>
        ...
        function createBlogCard(id, jobImage, jobDateCreated, jobRole, jobDescription, jobType, jobQualification) {
            ...
            // Create img element
            var imgElement = $("<img>").attr("src", "./assets/images/blog-2.jpg").attr("width", "370").attr("height", "370").attr("loading", "lazy").addClass("img-cover").attr("alt", "Become A Better Blogger: Content Planning");
            imgElement = $("<img>").attr("src", `./uploads/${jobImage}`).attr("width", "370").attr("height", "370").attr("loading", "lazy").addClass("img-cover").attr("alt", "Become A Better Blogger: Content Planning");
